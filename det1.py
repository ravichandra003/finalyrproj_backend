...
def run_yara_on_sample(yara_file, sample_file):
    ...
    for match in matches:
        ...
        for string_match in match.strings:
            # Access the matched string using the correct method
            matched_string = string_match[2].decode('utf-8') if isinstance(string_match, tuple) else string_match.instances[0].matched_data.decode('utf-8')
